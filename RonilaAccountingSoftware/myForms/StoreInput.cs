    ...
    public partial class StoreInput : Telerik.WinControls.UI.RadForm
    {
        ...
        public Models.StoreInput Setdata()
        {
            ...
            var info = new Models.StoreInput
            {
                ...
                storeInputShamsiProductionDate = txt_shamsiProductionDate.Text,
                storeInputMiladiProductionDate = txt_miladiProductionDate.Text,
                storeInputShamsiExpireDate = txt_shamsiExpireDate.Text,
                storeInputMiladiExpireDate = txt_miladiExpireDate.Text,
        ...
        private void radGridView1_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                ...
                cbx_Supplier.SelectedValue = radGridView1.CurrentRow.Cells["storeInputSupplierCode"].Value.ToString();
                ...
                txt_miladiExpireDate.Text = radGridView1.CurrentRow.Cells["storeInputAlarmDay"].Value.ToString();
        ...
        private void cbx_Supplier_Leave(object sender, EventArgs e)
        {
            ...
            txt_factorNumber.Text=(_services.GetMaxIdBySeller(SupplierId)+1).ToString();
        }

        private void txt_addPercent_TextChanged(object sender, EventArgs e)
        {
            double.TryParse(txt_BuyPrice.Text,out var BuyPrice);
